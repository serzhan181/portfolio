...
export const aboutData = {
  ...
  paragraphTwo:
    'Привет! Меня зовут Сержан, я из Казахстана. Изучаю фронтенд больше года. Всегда рад учится полезным навыкам и расширять знания в этом прогрессивном мире веба :)',
